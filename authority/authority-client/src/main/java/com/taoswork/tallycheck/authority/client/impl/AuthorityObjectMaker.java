...
final class AuthorityObjectMaker {
    public static IKProtection convert(FilterManager fm, ResProtection sr){
    ...
    public static IKProtectionCase makeRcProtectionCase(FilterManager fm, String resource, ResProtectionCase _case){
