...
public interface IEntityService<Pb extends Persistable> {
    ...
    <T extends Pb> PersistableResult<T> create(SecurityAccessor accessor, T entity) throws ServiceException;

    <T extends Pb> PersistableResult<T> read(SecurityAccessor accessor, Class<T> entityClz, Object key, ExternalReference externalReference) throws ServiceException;

    <T extends Pb> PersistableResult<T> update(SecurityAccessor accessor, T entity) throws ServiceException;

    <T extends Pb> boolean delete(SecurityAccessor accessor, Class<T> entityClz, Object key) throws ServiceException;
    ...
    <T extends Pb> T straightRead(SecurityAccessor accessor, Class<T> entityClz, Object key) throws ServiceException;
