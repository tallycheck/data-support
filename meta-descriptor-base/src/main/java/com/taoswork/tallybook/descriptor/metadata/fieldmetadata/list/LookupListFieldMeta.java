 ...
 */
public class LookupListFieldMeta extends ListFieldMeta<LookupListFieldMeta.Facet> {

    public LookupListFieldMeta(BasicFieldMetaObject bfmo, Facet facet) {
        super(bfmo, facet);
    }
    ...
    public static class Facet extends ListFacet {
        ...
        public Facet(Field field, boolean useAnnotation, Class explicitEntryTargetClass) {
            ...
            if(useAnnotation){
                ...
                if (!CollectionMode.Lookup.equals(cf.mode()) ) {
    ...
    public static class Seed implements IFieldMetaSeed {
        ...
        public IFieldMeta makeFieldMeta(BasicFieldMetaObject bfmo) {
            return new LookupListFieldMeta(bfmo, facet);
        }
    }
