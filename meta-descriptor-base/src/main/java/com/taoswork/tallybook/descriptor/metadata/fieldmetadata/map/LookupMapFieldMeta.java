 ...
 */
public class LookupMapFieldMeta extends MapFieldMeta<LookupMapFieldMeta.Facet> {

    public LookupMapFieldMeta(BasicFieldMetaObject bfmo, Facet facet) {
        super(bfmo, facet);
    }

    @Override
    public MapMode getMapMode() {
        return MapMode.Lookup;
    }
    ...
    public static class Seed implements IFieldMetaSeed {
        ...
        public IFieldMeta makeFieldMeta(BasicFieldMetaObject bfmo) {
            return new LookupMapFieldMeta(bfmo, facet);
        }
    }
